...
namespace WebShop.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(textdbMarketsContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int RoleID = 0, int Active = 0)
        {
            ...
            if (Active != 0)
            {
                accounts = accounts.Where(a => a.Active == (Active == 1));
            }

            return View(accounts.ToList());
        }

        public IActionResult Filtter(int RoleID = 0, int Active = 0)
        {
            var url = $"/Admin/AdminAccounts?RoleID={RoleID}&Active={Active}";
