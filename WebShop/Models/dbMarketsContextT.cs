...
{
    public partial class textdbMarketsContext : DbContext
    {
        public textdbMarketsContext()
        {
        }

        public textdbMarketsContext(DbContextOptions<textdbMarketsContext> options)
            : base(options)
        {
        }
